...
import org.apache.flink.training.exercises.ridesandfares.params.KafkaParameters;
import org.apache.flink.training.exercises.ridesandfares.params.OutputParams;
...
public class RidesAndFaresExercise {
    ...
    private JobExecutionResult execute(StreamExecutionEnvironment env) throws Exception {
    ...
    public static class EnrichmentFunction
        ...
        public void open(Configuration config) {
            this.fareValueState = getRuntimeContext().getState(new ValueStateDescriptor<>(
                    "aTaxiFare",
                    TaxiFare.class));
            this.rideValueState = getRuntimeContext().getState(new ValueStateDescriptor<>(
                    "aTaxiRide",
                    TaxiRide.class));
         }
